    ...
    render(){
        return(
            ...
            <Leftside textlineState={this.state.textlineOn}> 
                <Text>
                    <Textp1>Stream your favorite songs</Textp1>
                </Text>
                <Descriptiontext>
                    <Description1>With our library of over 60 million tracks and</Description1>
                    <Description2>250,000 videos, you’ll get the ultimate music</Description2>
                    <Description3>experience.</Description3>
                    <Description4>Create a playlist or try one of ours, hand-</Description4>
                    <Description5>curated by music editors and even the artists</Description5>
                    <Description6>themselves.</Description6>
                </Descriptiontext>
            </Leftside>
            <Album>
